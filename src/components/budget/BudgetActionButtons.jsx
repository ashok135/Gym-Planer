...
export const BudgetActionButtons = ({
  ...
  return (
    <div style={{ display: 'flex', gap: '8px', padding: '0 20px', marginBottom: '24px', flexWrap: 'wrap' }}>
      <button 
        onClick={() => { setShowAdd(true); setShowAddIncome(false); setShowAddDebt(false); }} 
      ...
      <button 
        onClick={() => { setShowAddIncome(true); setShowAdd(false); setShowAddDebt(false); }} 
      ...
      <button 
        onClick={() => { setShowAddDebt(true); setShowAdd(false); setShowAddIncome(false); }} 
